...
class antaParams(object):
    def __init__(self, param_file):
        try:
            ...
            self.struct_correction_term = float(config.get('PARAMETERS', 'struct_correction_term')) if config.get(
                'PARAMETERS', 'struct_correction_term') else 0.5
            ...
            self.seq_correction_term = float(config.get('PARAMETERS', 'seq_correction_term')) if config.get(
                'PARAMETERS', 'seq_correction_term') else 1.0
            self.degreeOfSequenceInducement = int(config.get('PARAMETERS', 'degreeOfSequenceInducement')) if config.get(
                'PARAMETERS', 'degreeOfSequenceInducement') else 1
            ...
            self.termination_convergence = int(config.get('PARAMETERS', 'termination_convergence')) if config.get(
                'PARAMETERS', 'termination_convergence') else 50
